        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-2 gap-0 rounded-xl border border-border overflow-hidden">
            <div className="bg-surface/50 p-6">
              <p className="text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-4 text-center">Traditional Agency</p>
            ...
            <div className="bg-accent/5 p-6">
              <p className="text-xs font-semibold uppercase tracking-wider text-accent mb-4 text-center">Awoken</p>
              <div className="space-y-3">
                {comparisons.map((item) => (
                  <motion.div
                    key={item.awoken}
                  ...
                  >
                    ...
                    <span className="text-sm font-medium">{item.awoken}</span>
                  </motion.div>
                ))}
              </div>
            </div>
