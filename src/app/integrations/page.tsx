...
export const metadata: Metadata = {
  title: "Integrations — Revenue Systems for Modern Businesses",
  description: "We work with your existing tools. Every system connects with your CRM, phone system, calendar, and more.",
}
